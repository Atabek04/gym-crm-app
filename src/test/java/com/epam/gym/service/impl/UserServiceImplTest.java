...
import com.epam.gym.service.impl.parameterResolver.UserServiceParameterResolver;
...
class UserServiceImplTest {
    ...
    void shouldUpdateUserPassword(UserService userService) {
        User originalUser = new User(1L, "John", "Doe", "john.doe",
                "password123", true);
        userService.create(originalUser, originalUser.getId());

        User updatedUser = new User(1L, "John", "Doe", "john.doe",
                "newPassword456", true);
    ...
    void shouldReturnAllUsers(UserService userService) {
        User user1 = new User(1L, "John", "Doe", "john.doe",
                "password123", true);
        User user2 = new User(2L, "Jane", "Smith", "jane.smith",
                "password456", false);
    ...
    void shouldDeleteUserSuccessfully(UserService userService) {
        ...
        var foundUser = userService.findById(1L).orElse(null);
